...
export function matches(
  ...
  return (isHTMLElementTagName(tagName) && element instanceof getHTMLElementReference(tagName) && element.matches(selector)) || (isSVGElementTagName(tagName) && element instanceof getSVGElementReference(tagName) && element.matches(selector)) || (isMathMLElementTagName(tagName) && element instanceof getMathMLElementReference(tagName) && element.matches(selector));
}
